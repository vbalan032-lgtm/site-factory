...
class BootstrapTests(unittest.TestCase):
    ...
    def test_new_is_dry_run_until_apply_then_creates_locked_starter(self):
        ...
        self.assertEqual(graph_profile["schema_version"], "1.1")
        self.assertEqual(project_knowledge["schema_version"], "1.1")
        self.assertEqual(len(graph_profile["stage_budgets"]), 7)
        self.assertEqual(lock["factory_version"], "1.1.0")
    ...
    def test_adopt_records_legacy_factory_snapshot_without_replacing_skills(self):
        ...
        backup = target / ".site-factory/backups/pre-update-1.1.0.zip"
